...
namespace Plasticore
{
    ...
    public class Gusset
    {
        private readonly DataAccessLayer.Gusset _gussetData;

        public Gusset(DataAccessLayer.Gusset gusset)
        {
            _gussetData = gusset;
        }
        ...
        {
            get { return (GussetOrientation) _gussetData.Orientation; }
            set { _gussetData.Orientation = (short) value; }
        }
        ...
        public decimal Size
        {
            get { return _gussetData.Size; }
            set { _gussetData.Size = value; }
        }
