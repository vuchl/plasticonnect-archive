...
namespace Plasticore
{
	...
	public class Gusset
	{
		...
		{
			get { return (GussetOrientation) EnumHelper_GussetOrientation; }
			set { EnumHelper_GussetOrientation = (int) value; }
		}

		[Column("Gusset_Orientation")]
		public int EnumHelper_GussetOrientation { get; internal set; }
