...
namespace ConsoleTester
{
	static class Scenarios
	{
		...
		public static void EditProduct(Product prod)
		{
			...
			prod.ProductNotes = "[some notes about product]";
			...
			EditColorInfo(prod.ProductColor);
			EditPrinting(prod.Printing);
			EditChemicalAdditives(prod);
		}
		...
		public static void EditColorInfo(ProductColor productColor)
		{
			productColor.ResinColor = ResinColor.Blue;
			productColor.Transparency = TransparencyType.Tint;
		}

		public static void EditPrinting(Printing printing)
		{
			printing.Type = PrintingType.Random;
			printing.Coloring = PrintingColoring.NoPrinting;
		...
		public static void EditChemicalAdditives(Product p)
		{
			p.ChemicalAdditives |= ChemicalAdditives.AntiBlock;
			p.ChemicalAdditives |= ChemicalAdditives.HighImpact;
