...
namespace Plasticonnect.Engine
{
	...
	public abstract class Product
	{
		...
		/// </summary>
		public bool HasPrinting { get; private set; }
		...
		///<summary>
		/// sets a new printing to the product
		///</summary>
		public void SetPrinting(PrintSideType printSide, TextDirectionType textDirection, string color1, string color2, decimal repeat, string description)
		{
			Printing.Color1 = color1;
			Printing.Color2 = color2;
			Printing.Description = description;
			Printing.PrintSide = printSide;
			Printing.Repeat = repeat;
			Printing.TextDirection = textDirection;
		}
